...
| # | label | what changed |
|---|---|---|
| 7 | `v7-templates-tab` | Templates moved off the first screen onto a tab of their own — nineteen chips was a wall you scrolled past to reach the button that makes the film. Each one now draws the shape of its cutting, which is the only part you can judge at a glance: two reels with the same median hold can be completely different edits. 23 reels, up from 18. In the app (not the published page, which has no ffmpeg) you can hand it a reel of your own and it will read the timing and throw the footage away. |
